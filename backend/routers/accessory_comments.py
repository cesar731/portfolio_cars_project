...
def create_comment(
    ...
    # 👇 Recargar el comentario con las relaciones necesarias para que Pydantic pueda serializarlo
    db_comment = (
        ...
        .filter(models.accessory_comment.AccessoryComment.id == db_comment.id)
        .first()
    )
    return db_comment
